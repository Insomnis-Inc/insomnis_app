...
class SVMessagesFragment extends StatefulWidget {
  @override
  State<SVMessagesFragment> createState() => _SVMessagesFragmentState();
}

class _SVMessagesFragmentState extends State<SVMessagesFragment> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Inbox', style: boldTextStyle(size: 20)),
